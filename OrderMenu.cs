namespace Project2fr
{
    public partial class Form1 : Form
    {
        ...
        double saladPrice, drinkPrice, dessertPrice, saladCost, drinkCost, dessertCost, totalCost;
        double fruitSaladQuantity, pastaSaladQuantity, smoothieQuantity, fruitJuiceQuantity, cupcakeQuantity, shortcakeQuantity, totalQuantity, drinkQuantity, dessertQuantity, saladQuantity;
        ...
        private void clearButt_Click_1(object sender, EventArgs e)
        {
            ...
            cupcakeRdo.Checked = false;
            shortcakeRdo.Checked = false;
            fruitJuiceRdo.Checked = false;
            pastaSaladRdo.Checked = false;
            fruitSaladRdo.Checked = false;
            smoothieRDB.Checked = false;
        }

        private void calcButt_Click(object sender, EventArgs e)
        {
            saladQuantity = Convert.ToDouble(saladQuantityTb.Text);
            saladCost =  saladQuantity * saladPrice;
            dessertQuantity = Convert.ToDouble(dessertQuantityTb.Text);
            dessertCost = dessertQuantity * dessertPrice;
            drinkQuantity = Convert.ToDouble(drinkQuantityTb.Text);
            drinkCost = drinkQuantity * drinkPrice;
            totalCost = dessertCost + drinkCost + saladCost;
            totalQuantity = dessertQuantity + drinkQuantity + saladQuantity;
            richTextBox1.Text = "The total sales was $" + totalCost.ToString() + "\n The total items sold were " + totalQuantity.ToString();

            //richTextBox1.Text = saladCost.ToString();
        }
