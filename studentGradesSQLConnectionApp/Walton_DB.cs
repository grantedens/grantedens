        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=ISYS3393.walton.uark.edu;Initial Catalog=3393_White_Fall2022p;user id=gaedens;password=BizDevPass10956948!;Persist Security Info=False;";
                }
